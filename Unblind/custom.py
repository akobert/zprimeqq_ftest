...
#        overall_conf = f" --expectSignal=0 "# --redefineSignalPOIs tf{args.year}_dataResidual_pt_par0_rho_par0 "
        overall_conf = ""# --redefineSignalPOIs tf{args.year}_dataResidual_pt_par0_rho_par0 "
...
#        overall_conf = f" --expectSignal=0 --setParameters r=0 --freezeParameters r --redefineSignalPOIs tf{args.year}_dataResidual_pt_par0_rho_par0 "  
    ...
    CONDOR_str = """ --job-mode condor --sub-opts='Requirements = (Arch == "X86_64")\n+RUQueue = "cms"\n+AccountingGroup = "group_rutgers.akobert"\n+SingularityImage = "/cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/el7:x86_64"\nshould_transfer_files = NO\n\nOutput = /home/akobert/CMSSW_11_3_4/src/zprimeqq_ftest/Unblind/CondorFiles/logfiles_FTest_$(cluster)_$(process).stdout\nError = /home/akobert/CMSSW_11_3_4/src/zprimeqq_ftest/Unblind/CondorFiles/run_$(cluster)_$(process).stderr\nLog = /home/akobert/CMSSW_11_3_4/src/zprimeqq_ftest/Unblind/CondorFiles/run_$(cluster)_$(process).condor' --task-name cfg_{}"""
    ...
    print("ws_base: "+str(ws_base))
    print("ws_alt: "+str(ws_alt))
    print("overall_conf: "+str(overall_conf))
    print("Dir Base: "+str(dir_base))
    print("Dir Alt: "+str(dir_alt))
    print("Dir Workdir: "+str(workdir))

    condor_total_command = ""  
    # Data fits
    if base:
        command = (
            "combineTool.py -M MultiDimFit --cminDefaultMinimizerStrategy 0 --robustFit=1 -v -1  "
        ...
        # Shapes from a fit
        command = (
            "combineTool.py -M FitDiagnostics --cminDefaultMinimizerStrategy 0 --robustFit=1 -v -1   "
        ...
        # GoFs Data
        command = ("combineTool.py -M GoodnessOfFit  --algo saturated --cminDefaultMinimizerStrategy 0 -v -1 "
