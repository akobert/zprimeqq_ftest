...
def prep_data(infile, reg, mc,year, lowbvl=False, highbvl=False):
    ...
    # Replacing {}_qcd with total_background
    #print("key",'shapes_prefit/total_background'.format(reg,year))
    prefit_qcd = infile['shapes_prefit/{}/total_background'.format(reg)].values()
    prefit_qcd_err = infile['shapes_prefit/{}/total_background'.format(reg)].variances()
    postfit_qcd = infile['shapes_fit_s/{}/total_background'.format(reg)].values()
    ...
    #print(data)
    bins = infile['shapes_prefit/total_background'.format(reg,year)].axis().edges()
    centers = infile['shapes_fit_s/total_background'.format(reg,year)].axis().centers()
...
if __name__ == "__main__":
    ...
    print("data_ref = "+str(data_ref))
    print("data_alt = "+str(data_alt))
    print("ref_pt = "+str(ref_pt))
    print("ref_rho = "+str(ref_rho))
    print("alt_pt = "+str(alt_pt))
    print("alt_rho = "+str(alt_rho))
    print("nbins = "+str(args.nbins))
